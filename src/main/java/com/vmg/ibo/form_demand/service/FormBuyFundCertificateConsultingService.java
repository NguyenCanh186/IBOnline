...
public class FormBuyFundCertificateConsultingService extends BaseService {
    ...
    public DemandForm saveFormBuyFundCertificateConsulting(FormBuyFundCertificateConsultingReq fundCertificateConsultingReq) {
        ...
        formBuyFundCertificateConsulting.setDeadlineForReceivingRegistrationPaymentFrom(fundCertificateConsultingReq.getDeadlineForReceivingRegistrationPaymentFrom());
        ...
        formBuyFundCertificateConsulting.setTags(DataModel.MFC);
